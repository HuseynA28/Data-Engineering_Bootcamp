...
SELECT *
FROM classicmodels.payments
WHERE paymentDate LIKE '2004-05-%'    -- All dates in May 2004
  AND checkNumber LIKE 'N%';          -- Check numbers starting with N/n (case-insensitive)
```
...
SELECT *
FROM classicmodels.customers
WHERE customerName LIKE '%nal%';  -- "National", "Final", "Analytics"
```
...
SELECT *
FROM classicmodels.customers
WHERE customerName LIKE '%lan_';  -- "AlanX", "Plan5"
```
